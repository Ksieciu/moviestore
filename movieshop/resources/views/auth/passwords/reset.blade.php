                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="login-box">
                            <label for="email" class="label-style">{{ __('Adres e-mail:') }}</label>
                              <br>  <input id="email" placeholder="Podaj adres e-mail" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                                <br>
                                @error('email')
